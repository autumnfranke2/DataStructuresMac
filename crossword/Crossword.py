...
def Board():
        ...
        txtbx25 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=309, y = 168)
        ...
        txtbx30 = eztext.Input(maxlength=1, color=(0,0,0), prompt='5: ', x=144, y = 204)
        txtbx31 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=165, y = 204)
        txtbx32 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=177, y = 204)
        txtbx33 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=189, y = 204)
        txtbx34 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=201, y = 204)
        txtbx35 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=213, y = 204)
        txtbx36 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=225, y = 204)
        txtbx37 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=237, y = 204)
        txtbx38 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=249, y = 204)
        txtbx39 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=261, y = 204)
        txtbx40 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=273, y = 204)
        txtbx41 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=285, y = 204)
        txtbx42 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=297, y = 204)
        ...
        txtbx61 = eztext.Input(maxlength=1, color=(0,0,0), prompt='10: ', x=211, y = 84)
        txtbx62 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 96)
        txtbx63 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 108)
        txtbx64 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 120)
        txtbx65 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 132)
        txtbx66 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 144)
        txtbx67 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 156)
        txtbx68 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 168)
        txtbx69 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 180)
        txtbx70 = eztext.Input(maxlength=1, color=(0,0,0), prompt=' ', x=226, y = 192)
        ...
        while not done:
                ...
                #Across5
                textandrectangle(155,204,txtbx30,events)
                textandrectangle(167,204,txtbx31,events)
                textandrectangle(179,204,txtbx32,events)
                textandrectangle(191,204,txtbx33,events)
                textandrectangle(203,204,txtbx34,events)
                textandrectangle(215,204,txtbx35,events)
                textandrectangle(227,204,txtbx36,events)
                textandrectangle(239,204,txtbx37,events)
                textandrectangle(251,204,txtbx38,events)
                textandrectangle(263,204,txtbx39,events)
                textandrectangle(275,204,txtbx40,events)
                textandrectangle(287,204,txtbx41,events)
                textandrectangle(299,204,txtbx42,events)
                ...
                #Down10
                textandrectangle(227,84,txtbx61,events)
                textandrectangle(227,96,txtbx62,events)
                textandrectangle(227,108,txtbx63,events)
                textandrectangle(227,120,txtbx64,events)
                textandrectangle(227,132,txtbx65,events)
                textandrectangle(227,144,txtbx66,events)
                textandrectangle(227,156,txtbx67,events)
                textandrectangle(227,168,txtbx68,events)
                textandrectangle(227,180,txtbx69,events)
                textandrectangle(227,192,txtbx70,events)
